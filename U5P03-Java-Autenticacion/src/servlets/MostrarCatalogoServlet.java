	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (request.getParameter("titulo") != null) {
				...
				out.println("<tr style='background-color:yellow'>" + "<td>Titulo</td>" + "<td>Autor</td>"
						+ "<td>Imagen</td></tr>");
				while (rset2.next()) {
					Obra obra3 = new Obra(rset2.getInt("idObra"), rset2.getString("titulo"), rset2.getInt("año"),
							rset2.getInt("idAutor"), rset2.getString("imagen"));

					out.println("<tr style='background-color:lightgreen'>");
					out.println("<td>" + obra3.getTitulo() + "</td>" + "<td> " + rset2.getString("nombre") + "</td>"
				...
				out.println("<tr style='background-color:yellow'>"
						...
						+ "<td>Imagen</td></tr>");
				while (rset.next()) {
					Obra obra = new Obra(rset.getInt("idObra"), rset.getString("titulo"), rset.getInt("año"),
							rset.getInt("idAutor"), rset.getString("imagen"));

					out.println("<tr style='background-color:lightgreen'>");
					out.println("<td>" + "<a href=MostrarObra?id_obra='" + obra.getIdObra() + "'>" + obra.getTitulo()
							+ "</td>" + "<td><a href=MostrarCatalogo?idAutor='" + obra.getIdAutor() + "'>"
							+ rset.getString("nombre") + "</td>" + "<td><img src='./img/" + obra.getImagen()
							+ "' width=100 heigh=100></td></tr>");
				}
				out.println("</table>");
				...
				while (rset1.next()) {
					...
					Obra obra1 = new Obra(rset1.getInt("idObra"), rset1.getString("titulo"), rset1.getInt("año"),
							rset1.getInt("idAutor"), rset1.getString("imagen"));
					Autor autor = new Autor(rset1.getInt("id"), rset1.getString("nombre"),
							rset1.getString("nacionalidad"), rset1.getString("genero"));

					out.println("<tr style='background-color:lightgreen'>");
					out.println("<td><a href=MostrarObra?id_obra='" + obra1.getIdObra() + "'>" + obra1.getTitulo()
							+ "</td><td> " + autor.getNombre() + "</td><td>" + autor.getNacionalidad()
