	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session != null) {
				...
				out.println("<div><h3>Inicio de sesión</h3>");
				out.println("<form action='" + request.getRequestURI() + "' method='post'>"
						+ "<div><label> Usuario:</label><br/><input type='text' name='username'></div><br/>"
						+ "<div><label> Contraseña:</label><br/><input type='password' name='password'></div><br/>"
